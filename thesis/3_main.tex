...
Figure \ref{fig:ces_com_2} shows a more complex example of multiple critical events with the same $\epsilon$. There are sixteen classical critical events at $\epsilon_0 = 3$: ten of type b and six of type c. Five critical events are on the bottom side, and five are on the top side of $\delta$. Six critical events are on the centre row of cells. There are two classical critical events of type c that lye on vertical cell borders.
