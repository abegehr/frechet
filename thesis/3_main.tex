...
For the example in figure \ref{fig:ces_min_2} the cross-sections $f_1(t)$ and $f_2(t)$ are shown in figure \ref{fig:ces_min_2_cs}.

 \begin{figure}[H]
    \centering
    
    \includegraphics[width=0.8\textwidth]{ces_min_2_cs.png}
