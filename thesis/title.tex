...
\begin{abstract}
   The classical Fréchet distance is the minimal connecting distance needed to monotonically traverse two paths completely. Lexicographic Fréchet matchings utilize steepest descent and apply the Fréchet distance recursively (divide and conquer) to minimize the time spent at distance greater than a threshold. 
\end{abstract}
